...
public final class FragmentReportsBinding implements ViewBinding {
  ...
  private FragmentReportsBinding(@NonNull LinearLayout rootView, @NonNull TextView emptyView,
  ...
  public static FragmentReportsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentReportsBinding((LinearLayout) rootView, emptyView, recyclerView, tabLayout,
          toolbar);
    }
